        ...
        children: [
          OTPTextField(
            ...
            otpFieldStyle: OtpFieldStyle(
              borderColor: AllColors.blueColor,
              enabledBorderColor: AllColors.blueColor,
              focusBorderColor: AllColors.blueColor,
            ),
            onChanged: (pin) {},
            onCompleted: (pin2) {
              pin = pin2;
  ...
  Widget nextButton() {
    return Container(
      ...
      child: ElevatedButton(
        ...
        child: const Text(
          "SUBMIT",
          style: TextStyle(color: AllColors.whiteColor, fontSize: 17, fontWeight: FontWeight.w500),
        ),
      ),
    );
  }
